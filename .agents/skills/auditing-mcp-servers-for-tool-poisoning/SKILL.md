...
- Before adding a new MCP server to an agent stack (Antigravity Desktop, Cursor, VS Code, Windsurf, custom agents).
...
- The MCP config file(s) you want to scan (e.g. `~/.cursor/mcp.json`, `~/.vscode/mcp.json`, Antigravity Desktop config).
- Install the tooling:
