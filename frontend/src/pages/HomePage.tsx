      ...
      <div className="mx-auto flex w-full flex-col gap-4">
        ...
        <div className="mail-card flex flex-col gap-1 w-full text-left transition-all" style={{ borderRadius: 12, padding: '15px' }}>
          ...
          <div className="flex items-center gap-2 mt-1">
            ...
            <div className="flex items-center gap-1.5 px-2 py-0.5 rounded-md" style={{ backgroundColor: 'rgba(124,58,237,0.1)' }}>
              <div className="w-1.5 h-1.5 rounded-full" style={{ backgroundColor: '#10B981' }}></div>
              <span className="text-[12px] font-bold" style={{ color: '#C4B5FD' }}>{activeProfile?.name || 'Не выбран'}</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 w-full">
          ...
          <div className="mail-card relative overflow-hidden group" style={{ borderRadius: 12, padding: '15px' }}>
            <div className="absolute -top-10 -right-10 w-32 h-32 rounded-full blur-[30px] transition-opacity" style={{ backgroundColor: 'rgba(139, 92, 246, 0.4)' }}></div>
            <p className="text-[11px] font-bold mb-1 relative z-10 tracking-wider uppercase" style={{ color: '#8B5CF6' }}>Рассылок сегодня</p>
            <div className="flex items-end justify-between relative z-10">
            ...
            <div className="flex rounded-full p-1 w-[150px]" style={{ backgroundColor: 'rgba(0,0,0,0.25)', border: '1px solid rgba(255,255,255,0.06)' }}>
              {(['today', 'month'] as StatsPeriod[]).map((period) => (
                <button
                  ...
                  className="flex-1 text-[10px] text-center uppercase tracking-wider py-1.5 rounded-full transition-all font-extrabold"
                  style={{
                    backgroundColor: sentPeriod === period ? 'rgba(139, 92, 246, 0.25)' : 'transparent',
                    color: sentPeriod === period ? '#8B5CF6' : '#64748B',
                  }}
                >
                  {period === 'today' ? 'Сегодня' : 'Месяц'}
                </button>
        ...
        <div className="relative w-full">
          ...
          >
            ...
            <div className="flex items-center gap-5 px-1" style={{ marginBottom: '15px' }}>
              <div className="shrink-0 rounded-full flex items-center justify-center text-xl font-bold overflow-hidden shadow-[0_4px_20px_rgba(124,58,237,0.3)]" style={{ width: '64px', height: '64px', minWidth: '64px', minHeight: '64px', backgroundColor: '#7C3AED', color: 'white' }}>
                {account?.telegramAvatarBase64 ? (
                  <img src={account.telegramAvatarBase64} alt="Avatar" className="w-full h-full object-cover" />
                ) : (
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      paddingLeft: '15px',
                      paddingRight: '15px',
                      backgroundColor: isCurrent ? 'rgba(124,58,237,0.15)' : 'rgba(255, 255, 255, 0.03)',
                      border: isCurrent ? '1px solid rgba(124,58,237,0.3)' : '1px solid rgba(255, 255, 255, 0.08)',
                      backdropFilter: 'blur(12px)'
                    }}
                  >
                    <div className="w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold shrink-0 shadow-sm" style={{ backgroundColor: p.color || '#7C3AED', color: 'white' }}>
          ...
          >
            <div>
              ...
              <button 
                ...
                style={{ height: '56px', backgroundColor: '#7C3AED', boxShadow: '0 4px 15px rgba(124,58,237,0.3)' }}
              >
                Создать профиль
              </button>
            </div>
