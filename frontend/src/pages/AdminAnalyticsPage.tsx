...
const FIXED_MODELS = [
  ...
  { providerName: 'ZAI', modelName: 'glm-4.7-flash' },
  { providerName: 'ZAI', modelName: 'glm-4.5-flash' },
  { providerName: 'Kimi', modelName: 'kimi-k2.7-code-highspeed' },
  { providerName: 'Kimi', modelName: 'kimi-k2.6' },
  { providerName: 'Kimi', modelName: 'moonshot-v1-8k' },
  { providerName: 'Gemini', modelName: 'gemini-2.5-flash-lite' },
  { providerName: 'Gemini', modelName: 'gemini-2.0-flash' },
  { providerName: 'Qwen', modelName: 'qwen-flash' },
  { providerName: 'Qwen', modelName: 'qwen-plus-latest' },
  { providerName: 'Qwen', modelName: 'qwen-turbo-latest' },
