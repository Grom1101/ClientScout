        ...
        {step === 'PHONE' && (
          <form onSubmit={handleSendPhone} className="flex flex-col gap-4">
            <input
              ...
              className="w-full p-3 bg-white/5 border border-white/10 rounded-md text-white outline-none focus:border-[#0EA5E9] focus:bg-white/[0.07]"
              value={phone}
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 bg-[#0EA5E9] hover:bg-[#0284C7] text-white font-medium rounded-md transition-colors disabled:opacity-50"
            >
