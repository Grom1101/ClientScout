...
export function TelegramAuthModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="w-full max-w-sm rounded-2xl overflow-hidden shadow-2xl border border-sky-400/15" style={{ background: 'linear-gradient(180deg, #2B2B2B 0%, #202020 100%)' }}>
        <div className="p-6">
